...
if __name__ == "__main__":
    ...
    Order.create(name="Таблетки для посудомоечной машины Fairy Platinum All in One", info="Экологичные капсулы Fairy Platinum All in One с лимоном обеспечивают защиту компонентов посудомоечной машины и удаляют сложные загрязнения с посуды с первого раза, сообщая посуде приятный цитрусовый аромат, а посудомойке — чистоту и свежесть.", user_id=1, longitude=56.12314, latitude=67.135135)
